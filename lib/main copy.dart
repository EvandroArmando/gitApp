...
import 'package:git_app/flutter_curso_avancado/Views/HomeValueNotifier.dart';
...
import 'package:git_app/flutter_curso_avancado/home_change_notifier.dart';
    ...
    return ListenableBuilder(
      ...
      builder: (context, child) {
        return MaterialApp(
          title: 'Flutter Demo',
          theme:
              themeDataController.isDarkMode
                  ? ThemeData.dark()
                  : ThemeData.light(),
          home: HomeValueNotifier(),
        );
      },
    );
  }
